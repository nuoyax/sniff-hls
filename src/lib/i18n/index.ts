...
const en: Dict = {
  ...
  'manager.openFile': 'Double-click to play · click ▶ to open',
  'manager.openFile.missing': 'File location unknown for this record — re-download to enable one-click open.',
  'manager.delete': 'Delete file + record',
  'pager.prev': 'Prev',
  'pager.next': 'Next',
  'pager.page': 'Page',
...
const zh: Dict = {
  ...
  'manager.pause': '暂停',
  'manager.resume': '继续',
  'manager.openFile': '双击播放 · 点 ▶ 打开文件',
  'manager.openFile.missing': '此记录没有文件位置信息，请重新下载后即可一键打开。',
  'manager.delete': '删除文件+记录',
  'pager.prev': '上一页',
  'pager.next': '下一页',
  'pager.page': '第',
