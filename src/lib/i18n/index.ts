...
const en: Dict = {
  ...
  'settings.persist.hint': 'All changes are saved automatically.',
  ...
  'downloads.subfolder': 'Download subfolder',
...
const zh: Dict = {
  ...
  'settings.persist.hint': '所有修改自动保存。',
